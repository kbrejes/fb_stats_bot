...
class TestHealthChecker:
    ...
    def test_format_uptime(self, health_checker):
        ...
        assert "1d 1h 5m" in health_checker._format_uptime(90300)  # 1 day 1 hour 5 minutes
    ...
    async def test_get_full_health_status(self, health_checker):
        ...
        with patch.object(health_checker, 'check_database') as mock_db, \
             patch.object(health_checker, 'check_openai_api') as mock_openai, \
             patch.object(health_checker, 'check_facebook_api') as mock_fb:
