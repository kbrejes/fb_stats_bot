...
from src.bot.analytics_handlers import (
...
async def test_handle_comparison(callback_query, sample_account):
    ...
    with patch('src.bot.analytics_handlers.FacebookAdsClient') as mock_fb_client, \
         patch('src.bot.analytics_handlers.analytics_service') as mock_analytics, \
         patch('src.bot.analytics_handlers.DataProcessor') as mock_processor:
