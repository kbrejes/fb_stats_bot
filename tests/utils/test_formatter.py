...
async def test_formatter(user_id: int, object_id: str, object_type: str = 'account', 
...
def parse_args():
    parser = argparse.ArgumentParser(description='Test the message formatter with custom conversions')
    parser.add_argument('--user_id', type=int, default=400133981, help='Telegram user ID')
    parser.add_argument('--object_id', type=str, default='act_8774430319299378', help='Object ID (account, campaign, etc.)')
    parser.add_argument('--object_type', type=str, choices=['account', 'campaign', 'adset', 'ad'], 
                        default='account', help='Object type')
    parser.add_argument('--date_preset', type=str, default='yesterday', help='Date preset (today, yesterday, last_7d, etc.)')
