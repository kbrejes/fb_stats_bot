...
class DataExporter:
    ...
    @staticmethod
    def export_to_csv(data: Union[List[Dict], pd.DataFrame], 
                      filename: Optional[str] = None) -> Tuple[BytesIO, str]:
        """
    ...
    @staticmethod
    def export_to_json(data: Union[List[Dict], pd.DataFrame], 
                       filename: Optional[str] = None) -> Tuple[BytesIO, str]:
        """
    ...
    @staticmethod
    def export_to_excel(data: Union[List[Dict], pd.DataFrame, Dict[str, Union[List[Dict], pd.DataFrame]]], 
                         filename: Optional[str] = None) -> Tuple[BytesIO, str]:
        """
    ...
    @staticmethod
    def export_data(data: Union[List[Dict], pd.DataFrame, Dict[str, Union[List[Dict], pd.DataFrame]]], 
                     format: str = 'csv',
                     filename: Optional[str] = None) -> Tuple[BytesIO, str]:
        """
